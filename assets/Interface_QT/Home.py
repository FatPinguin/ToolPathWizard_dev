...
class Ui_Dialog_home(object):
    def setupUi(self, Dialog_home):
        ...
        Dialog_home.resize(340, 690)
        Dialog_home.setMinimumSize(QtCore.QSize(340, 690))
        Dialog_home.setMaximumSize(QtCore.QSize(340, 690))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 80, 297, 591))
...
if __name__ == "__main__":
    ...
    Dialog_home = QtWidgets.QDialog()
    ui = Ui_Dialog_home()
    ui.setupUi(Dialog_home)
    Dialog_home.show()
    sys.exit(app.exec_())
